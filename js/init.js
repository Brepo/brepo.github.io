...
(function($) {
    ...
    $(function() {
        ...
        // Contact Form
        $('#mc').ajaxChimp({
            url: 'http://Readybox.us10.list-manage.com/subscribe/post?u=284ac1dfc03452785fb103399&amp;id=3da06c0c6d',
            callback: mcResponse
        });

        function mcResponse(resp) {
        	console.log(resp);
            if (resp.result === 'success') {
                $('#mc input[type="submit"]').attr('value', 'Submitted!')
            }
        }
